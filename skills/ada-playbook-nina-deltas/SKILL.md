---
name: ada-playbook-nina-deltas
description: The delta on top of the two playbooks, from 17 further Nina and Daniel one-to-one calls. Use ALONGSIDE ada-playbook-ecom or ada-playbook-leadgen whenever the question touches a rule they state: it falsifies one of their named diagnostic rules on tape four times, answers three of their open questions, and adds checks neither carries.
category: account-management
author: dan
status: production
created: 2026-08-25
source: docs/playbooks/playbook-delta-nina-calls.md
---
